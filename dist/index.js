  ...
  methods: {
    onCancelEv: function onCancelEv() {
      ...
      (0, _animejs2.default)({
        ...
        _this.backgroundEffectEl && _this.cancelBackgroundEffect();
      };
    },
    onConfirmEv: function onConfirmEv() {
      var _this2 = this;

      var tl = new _animejs2.default.timeline();
      ...
      tl.add({
        ...
        _this2.show = false;
        _this2.onConfirm && _this2.onConfirm();
        _this2.backgroundEffectEl && _this2.cancelBackgroundEffect();
      };
    },
...
/* harmony import */ var _index_vue_vue_type_style_index_0_id_2964abc9_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(49);
